...
function ProjectCard({project}){
	...
	return (
		<div onClick={()=> router.push(`/project/${project.id}/widget/${project.project_widgets[0]?.id}`)} className="py-4 px-4 rounded-md border border-stroke-grey bg-blue-600 w-[193px] cursor-pointer hover:scale-[102%] transition-all"> 
