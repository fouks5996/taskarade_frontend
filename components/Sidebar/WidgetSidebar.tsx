...
export default function WidgetSidebar() {
	...
	const { id } = router.query as queryTypes;
	...
	return (
		<div className='w-[260px] border-r border-stroke-blue max-w-[260px] flex justify-center items-center p-5 absolute top-0 left-[0px] h-screen bg-blue-700'>
					...
					<div>
						...
						<div className='flex flex-col gap-1.5'>
							{project.data?.attributes.project_widgets.data
								.filter((widget: { attributes: { name: string } }) =>
			...
			<ModalTemplate IsOpen={modalIsOpen} onRequestClose={closeModal}>
				<ProjectModal setIsOpen={setIsOpen} />
			</ModalTemplate>
		</div>
	);
}
